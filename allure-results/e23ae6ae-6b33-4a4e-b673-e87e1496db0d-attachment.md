              ...
              - generic [ref=f1e2]:
                ...
                - generic [ref=f1e7]:
                  - generic [ref=f1e8]:
                    ...
                    - textbox "Vehicle name" [active] [ref=f1e10]:
...
```ts
  1  | import { test, expect, FrameLocator, Locator, Frame } from '@playwright/test';
  2  | 
...
> 8  |     const headerText = await mainFrame.locator('h2').innerText();
  ...
  22 |     await sideFrame.getByTestId('side-link-registration').click();
  23 | 
