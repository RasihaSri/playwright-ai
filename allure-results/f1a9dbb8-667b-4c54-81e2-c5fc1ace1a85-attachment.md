...
Locator: locator('#selenium-tab-panel strong')
Expected substring: "Switch Commands"
Received string:    "Switch commands"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('#selenium-tab-panel strong')
    9 × locator resolved to <strong>Switch commands</strong>
      - unexpected value "Switch commands"
        ...
        - generic [ref=e244]:
          ...
          - generic [ref=e353]:
            ...
            - tablist [ref=e355]:
              ...
              - tab "Switch Commands" [active] [ref=e358] [cursor=pointer]
...
> 33 |     await expect (page.locator('#selenium-tab-panel strong')).toContainText('Switch Commands');
     |                                                               ^ Error: expect(locator).toContainText(expected) failed
  34 | 
  35 |     // upload/download 
  36 |     await page.getByLabel('Upload Image').setInputFiles('tests/07_Web_Tables/qa_gridhub_logo.png');
  37 |     const download = page.getByRole('link', { name: 'Download File' });
  38 |     await expect (download).toHaveAttribute('href', 'https://app.thetestingacademy.com/playwright/tables/practice/download/sampleFile.txt');
  39 | 
