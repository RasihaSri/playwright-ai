...
```
Error: locator.click: SyntaxError: Failed to execute 'evaluate' on 'Document': The string '(//*[name()='path' and contains(@class,'INUP')]' is not a valid XPath expression.
...
Call log:
  - waiting for locator('xpath=(//*[name()=\'path\' and contains(@class,\'INUP\')]')
