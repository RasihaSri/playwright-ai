...
Expected: "https://app.thetestingacademy.com/playwright/tables/practice/download/sampleFile.txt"
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Download File' })
    9 × locator resolved to <a id="download-file" data-testid="download-file" download="sample-download.txt" class="tta-button is-secondary" href="/playwright/sample-download.txt">…</a>
