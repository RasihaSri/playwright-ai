...
Expected: "https://app.thetestingacademy.com/playwright/tables/practice/download/sample-download.txt"
...
> 38 |     await expect (download).toHaveAttribute('href', 'https://app.thetestingacademy.com/playwright/tables/practice/download/sample-download.txt');
     |                             ^ Error: expect(locator).toHaveAttribute(expected) failed
  39 | 
