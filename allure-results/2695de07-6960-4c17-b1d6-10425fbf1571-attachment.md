...
Locator: locator('#selenium-tab-panel')
Expected substring: "Switch Commands"
Received string:    "Switch commands — switch between windows, frames, and alerts.driver.switchTo().frame('main'); driver.switchTo().alert().accept();"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('#selenium-tab-panel')
    9 × locator resolved to <div class="tab-panel" data-active="switch" id="selenium-tab-panel">…</div>
      - unexpected value "Switch commands — switch between windows, frames, and alerts.driver.switchTo().frame('main'); driver.switchTo().alert().accept();"
