...
Call log:
  ...
  "at": "2:35:09 AM"
    ...
    2 × locator resolved to <div id="output" data-testid="ctx-output" class="submission-output">{↵  "action": "cut",↵  "label": "Cut",↵  "target"…</div>
      - unexpected value "{
  "action": "cut",
  "label": "Cut",
  "target": "ctx-target",
      ...
      - main [ref=e231]:
        ...
        - generic [ref=e241]:
          - article [ref=e243]:
            ...
            - generic [ref=e263]: "{ \"action\": \"cut\", \"label\": \"Cut\", \"target\": \"ctx-target\", \"at\": \"2:35:09 AM\" }"
...
```ts
  ...
  12 |         await page.getByText(option, { exact: true}).click();
