...
- Name: 08_Web_Select_Frames_Iframe\237_Advanced_Select_Pro.spec.ts >> Basic Web Test - Verify Page Title
- Location: tests\08_Web_Select_Frames_Iframe\237_Advanced_Select_Pro.spec.ts:3:5
...
Call log:
  - waiting for getByText('New York')
        ...
        - generic [ref=e243]:
          ...
          - generic [ref=e270]:
            ...
            - generic [ref=e276]:
              - generic [ref=e277]:
                - generic [ref=e278]:
                  - generic [ref=e279]: Pytest
                  - button "Remove Pytest" [ref=e280] [cursor=pointer]:
                    - img [ref=e281]
                - generic [ref=e283]:
                  - generic [ref=e284]: JUnit
                  - button "Remove JUnit" [ref=e285] [cursor=pointer]:
                    - img [ref=e286]
                - textbox "Filter options" [ref=e289]
              - generic [ref=e290]:
                - button "Clear values" [ref=e291] [cursor=pointer]:
                  - img [ref=e292]
                - img [ref=e296]
            - generic [ref=e298]:
              - generic [ref=e299]:
          ...
          - generic [ref=e305]:
            ...
            - generic [ref=e312]:
              - generic [ref=e313]:
                - generic [ref=e314]:
                  - generic [ref=e315]: api-testing
                  - button "Remove api-testing" [ref=e316] [cursor=pointer]:
                    - img [ref=e317]
                - generic [ref=e319]:
                  - generic [ref=e320]: security
                  - button "Remove security" [ref=e321] [cursor=pointer]:
                    - img [ref=e322]
                - textbox "Add a tag" [ref=e325]
              - generic [ref=e326]:
                - button "Clear values" [ref=e327] [cursor=pointer]:
                  - img [ref=e328]
                - img [ref=e332]
            - generic [ref=e334]:
              - generic [ref=e335]:
              ...
              - generic [ref=e337]:
                - generic [ref=e338]: create
                - text: =press Enter
          - generic [ref=e339]:
            - generic [ref=e340]:
              - heading "④ Grouped — categorised options" [level=2] [ref=e341]
              - generic [ref=e342]: Groups
            - paragraph [ref=e343]: Options are split into labelled groups. Practise reaching an option inside a specific group heading.
            - generic [ref=e345]:
              - generic [ref=e346]:
                - generic [ref=e347]: Pick a deployment target…
                - textbox "Filter options" [ref=e349]
              - img [ref=e353]
            - generic [ref=e355]:
              - generic [ref=e356]:
                - generic [ref=e357]: data-testid
                - text: =rs-grouped
              - generic [ref=e358]:
          ...
          - generic [ref=e360]:
            - generic [ref=e361]:
              - heading "⑤ Async — fetched on type" [level=2] [ref=e362]
              - generic [ref=e363]: 600ms latency
            - paragraph [ref=e364]:
              - text: Type a city name. Results load after a simulated 600ms network call. Practise
              - code [ref=e365]: page.waitForResponse
              - text: patterns or just await a visible option.
            - generic [ref=e366]:
              - generic [ref=e367]:
                - generic [ref=e368]:
                  - generic [ref=e369]: Type to search cities…
                  - textbox "Search cities" [active] [ref=e371]
                - img [ref=e374]
              - listbox [ref=e376]:
                - generic [ref=e377]: Type at least 2 characters…
            - generic [ref=e378]:
              - generic [ref=e379]:
                - generic [ref=e380]: data-testid
                - text: =rs-async · rs-async-input · rs-async-menu
              - generic [ref=e381]:
                - generic [ref=e382]: state
                - text: =loading / no-results / results
          - generic [ref=e383]: "{ \"rs-single\": \"Cypress\", \"rs-multi\": [ \"Pytest\", \"JUnit\" ], \"rs-creatable\": [ \"api-testing\", \"security\" ], \"rs-grouped\": null, \"rs-async\": null }"
        - complementary [ref=e384]:
          - generic [ref=e385]:
            - heading "What students should practise" [level=3] [ref=e386]
            - list [ref=e387]:
              - listitem [ref=e388]:
                - text: Click
                - code [ref=e389]: .tta-rs__control
                - text: to open, then click
                - code [ref=e390]: .tta-rs__option
                - text: by visible text.
              - listitem [ref=e391]:
                - text: Type into
                - code [ref=e392]: .tta-rs__input-container input
                - text: to filter options.
              - listitem [ref=e393]:
                - text: "Multi: remove a chip via its"
                - code [ref=e394]: .tta-rs__multi-value__remove
                - text: button.
              - listitem [ref=e395]: "Creatable: type a brand-new value and press Enter; assert the chip appears."
              - listitem [ref=e396]:
                - text: "Grouped: scope a query under a specific"
                - code [ref=e397]: .tta-rs__group[data-group="Edge"]
                - text: .
              - listitem [ref=e398]: "Async: wait for the loading notice to disappear, then click the result."
          - group [ref=e399]:
            - generic "Playwright solutions One snippet per variant. Show solution" [ref=e400] [cursor=pointer]:
              - img [ref=e402]
              - generic [ref=e404]:
                - strong [ref=e405]: Playwright solutions
                - generic [ref=e406]: One snippet per variant.
              - generic [ref=e407]: Show solution
```
...
```ts
  ...
  8  |     await page.getByText("Cypress", { exact: true }).click();
  9  | 
  10 |     await page.locator("#rs-multi").click();
  11 |     await page.getByText("Pytest", { exact: true }).click();
  12 |     await page.getByText("JUnit", { exact: true }).click();
  13 |     await page.keyboard.press("Escape");
  14 | 
  15 |     await page.locator("#rs-creatable").click();
  16 |     await page.getByText("api-testing", { exact: true }).click();
  17 |     await page.getByText("security", { exact: true }).click();
  18 |     await page.keyboard.press("Escape");
  19 | 
  20 |     await page.locator("#rs-async").click();
  21 |     await page.waitForSelector(".tta-rs__menu-notice");
> 22 |     await page.getByText("New York").click();
     |                                      ^ Error: locator.click: Test timeout of 30000ms exceeded.
  23 | 
