...
let c = new Car("Tesla"); // Vehicle: Car
                         // Brand: Tesla
...
console.log("Area:", r.area()); // Area: 15
...
console.log(new Child().greet()); // Hello World
...
console.log(t instanceof Car1); // true
console.log(t instanceof Vehicle1); // true
