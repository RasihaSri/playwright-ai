...
Purpose: Alternative frameworks for structuring prompts Chapter: 2 - Prompt Engineering
...
### STAR Example (QA)
SITUATION:
We have an e-commerce checkout system that was recently updated with a new payment gateway. Users have reported intermittent failures.
...
RESULT:
Deliver a test plan with 15-20 test cases covering all payment scenarios, prioritized by risk.
...
EXAMPLES:
Good test case: "TC_001 | Transfer $100 between accounts | Steps: 1. Login 2. Select transfer 3. Enter amount | Expected: Success message, balance updated"
...
## See Also
- RICE POT Framework (Recommended for QA)
- Anatomy of a Prompt

Author: Pramod Dutta
Role: Principal SDET
Website: The Testing Academy
LinkedIn: linkedin.com/in/pramoddutta
